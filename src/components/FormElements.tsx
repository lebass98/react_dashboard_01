            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input type="text" placeholder="info@gmail.com" className="w-full pl-11 pr-4 py-3 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:border-indigo-500 dark:focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 dark:focus:ring-indigo-900 outline-none transition-all" />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex">
                  ...
                  <input type="text" placeholder="+1 (555) 000-0000" className="flex-1 px-4 py-3 rounded-r-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 dark:focus:ring-indigo-900 outline-none transition-all placeholder-slate-400 dark:placeholder-slate-500" />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex">
                  ...
                  <div className="relative group min-w-[80px]">
                    <select className="w-full h-full pl-4 pr-8 py-3 rounded-r-lg border border-l-0 border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 text-slate-900 dark:text-white outline-none appearance-none cursor-pointer">
                      <option>US</option>
                    </select>
                    <ChevronDown className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 pointer-events-none" />
                  </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <label htmlFor="file-upload" className="flex items-center w-full px-4 py-3 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 cursor-pointer hover:border-indigo-500 dark:hover:border-indigo-500 transition-all overflow-hidden whitespace-nowrap">
                  <span className="bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-400 dark:text-slate-300 px-3 py-1 rounded-md text-sm font-semibold mr-4 shrink-0">파일 선택</span>
